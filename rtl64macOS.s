...
//ld rtl64macOS.o -e _main -o rtl64macOS -lSystem
...
ReadCharBuffer:
    .byte 0x3c
    .byte 0x00  // Добавление дополнительных байтов для выравнивания
    .byte 0x00
    .byte 0x00
    .byte 0x00  // Добавляем еще 4 байта, чтобы размер стал 8
    .byte 0x00
    .byte 0x00
    .byte 0x00
